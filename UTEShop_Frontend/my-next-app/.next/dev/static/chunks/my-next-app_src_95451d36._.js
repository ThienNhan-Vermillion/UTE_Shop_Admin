...
function CategoriesManagement() {
    ...
    const fetchCategories = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$src$2f$services$2f$api$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategories"])();
            if (data.success) {
    ...
    const handleAddCategory = async ()=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$src$2f$services$2f$api$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCategory"])({
            ...
            console.error('Lỗi khi tạo loại sản phẩm:', err_0);
    ...
    const handleUpdateCategory = async ()=>{
        ...
        try {
            const response_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$src$2f$services$2f$api$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCategory"])(editingCategory.id, {
            ...
            if (response_0.success) {
                ...
                alert('Có lỗi xảy ra: ' + response_0.message);
            }
        } catch (err_1) {
            console.error('Lỗi khi cập nhật loại sản phẩm:', err_1);
    ...
    const confirmDeleteCategory = async ()=>{
        ...
        try {
            const response_1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$src$2f$services$2f$api$2e$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCategory"])(deletingCategory.id);
            if (response_1.success) {
                setCategories((prev_0)=>prev_0.filter((cat_0)=>cat_0.id !== deletingCategory.id));
                setShowDeleteModal(false);
                setDeletingCategory(null);
                alert('Xóa loại sản phẩm thành công!');
            } else {
                alert('Có lỗi xảy ra: ' + response_1.message);
            }
        } catch (err_2) {
            console.error('Lỗi khi xóa loại sản phẩm:', err_2);
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        ' ',
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                            children: [
                                                '"',
...
_s(CategoriesManagement, "/LxaLWzyLYynlDPZrNoV/W4LZxo=");
...
//# sourceMappingURL=my-next-app_src_95451d36._.js.map