...
"[project]/my-next-app/src/components/VoucherManagement.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VoucherManagement() {
    const [vouchers, setVouchers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [editingVoucher, setEditingVoucher] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const fetchVouchers = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$src$2f$services$2f$api$2e$services$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getVouchers"])();
            if (response.success) {
    ...
    const handleDelete = async (voucher)=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$next$2d$app$2f$src$2f$services$2f$api$2e$services$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteVoucher"])(voucher.id);
            if (response.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a34d66d._.js.map